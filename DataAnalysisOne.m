...
for w = 1:length(Files)
    ...
    ForceTrimBkpR = ForceTrim;
    [~,LPeakFit] = envelope(ForceTrim.Data,95,'peak');
    ForceTrim.Data = ForceTrim.Data - LPeakFit;
...
for w = 1:length(Files)
    ...
    % Get rid of trending data with envelope function
    ForceTrimBkpL = ForceTrim;
    [~,LPeakFit] = envelope(ForceTrim.Data,80,'peak');
    ForceTrim.Data = ForceTrim.Data - LPeakFit;
